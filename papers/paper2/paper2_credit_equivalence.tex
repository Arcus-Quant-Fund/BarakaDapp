...
%%  Ahmed, Bhuyan & Islam — February 2026 (revised March 2026)
%% ============================================================
...
\author[1]{Shehzad Ahmed\thanks{Corresponding author.
\textit{Conflict of interest disclosure}: The corresponding author
has developed an open-source blockchain implementation of the
theoretical framework described in this paper
(Baraka Protocol, deployed on Arbitrum Sepolia).
Code is publicly available at
\url{https://github.com/Arcus-Quant-Fund/BarakaDapp}.
The authors declare no financial conflict of interest;
the implementation was created to validate the theory empirically.}}
\author[2]{Rafiqul Bhuyan}
\author[3]{Rubaiyat Islam}

\affil[1]{Department of Finance, Independent University,
Bangladesh.\ \small\texttt{2120922@iub.edu.bd}}
\affil[2]{Department of Finance and Economics, Alabama A\&M
University, USA\,;\, Adjunct Professor, Monarch Business School
Switzerland.\ \small\texttt{rafiqul.bhuyan@aamu.edu}}
\affil[3]{Department of Software Engineering, Daffodil
International University, Bangladesh.\
\small\texttt{islam.swe@diu.edu.bd}}
...
\noindent\textbf{Shehzad Ahmed:}
Conceptualization, Formal analysis, Methodology, Software,
Visualization, Writing --- original draft.
\textbf{Rafiqul Bhuyan:}
Conceptualization, Methodology, Supervision,
Writing --- review and editing.
\textbf{Rubaiyat Islam:}
Methodology, Validation, Writing --- review and editing.

\subsection*{Declaration of Competing Interest}
\noindent The corresponding author (S.\ Ahmed) has developed an
open-source smart-contract implementation of the pricing framework
described in this paper (Baraka Protocol,
\url{https://github.com/Arcus-Quant-Fund/BarakaDapp}).
No financial interest or commercial funding was involved.
